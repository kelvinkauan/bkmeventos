                ...
                <tr>
                    <?php if (isset($data['organizadores'])) {
                        foreach ($data['organizadores'] as $org) : ?>
                            ...
                            <td><a href="javascript:confirmarAdmExcluiOrg('<?= $org['nc_Organizador'] ?>',<?= $org['idOrganizador'] ?>)"><svg xmlns="http://www.w3.org/2000/svg" width="70" height="16" fill="currentColor" class="bi bi-trash3 d-flex justify-content-around" viewBox="-22 0 16 16">
