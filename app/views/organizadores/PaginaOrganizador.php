...
<head>
    ...
    <script src="./../views/helpers/excluirevento.js" type="text/javascript"></script>
                                                                 <script src="./../views/helpers/funcoescrud.js"></script>
    <style>
        h1:hover {
            color: #6F3Df4;
        }
                ...
                <tr>
                    <?php if (isset($data['organizador'])) {
                        ...
                        ?>
                            ...
                            <td><a href="javascript:confirmarExclusaoOrganizador('<?= $org['nc_Organizador'] ?>',<?= $org['idOrganizador'] ?>)"><svg xmlns="http://www.w3.org/2000/svg" width="70" height="16" fill="currentColor" class="bi bi-trash3 d-flex justify-content-around" viewBox="-25 0 16 16">
